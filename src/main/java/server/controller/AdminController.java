...
public class AdminController {
    ...
    public ResponseEntity<Map<String, Float>> getStatistics(@RequestParam(required = false) String minDate,
                                                             @RequestParam(required = false) String maxDate) {
        Map<String, Float> response = adminService.getStatistics(minDate, maxDate);
